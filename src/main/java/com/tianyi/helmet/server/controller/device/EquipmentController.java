...
public class EquipmentController {
    ...
    @Transactional
    public ResponseVo codeWarehousing(@RequestParam String deviceNumber, @RequestParam String deviceUUID,
...
//        String deviceUUID = HelmetImeiHolder.get();
    ...
    public ResponseVo getDeviceListByKeywords(@RequestParam(required = false) Integer affiliationId,
        ...
        Map<String, Object> map = resoveParams(affiliationId, userName, categoryId, versionId, model, batch, startTime, endTime, deviceNumber);
...
//        logger.debug("进入已售头盔地图定位功能,头盔=" + tripleVoList);
    ...
    public ResponseVo<List<QuadrupleVo<String, String, Boolean, HelmetGps>>> refreshAll() {
        ...
        if (userInfo.isAdmin() || userInfo.isDemo()) {
            helmetList = equipmentService.selectByType(true);
        ...
        List<QuadrupleVo<String, String, Boolean, HelmetGps>> clientList = helmetList
                ...
                .map(helmet -> {
                    ...
                    if (user != null && helmet.getFlag() == 1) {
                        qv = new QuadrupleVo(helmet.getDeviceUUID(), helmet.getDeviceNumber(), equipmentService.isOnLine(helmet.getDeviceUUID()), gps);
                    }
                    return qv;
                })
    ...
    @RequestMapping(value = "ledger/clear", method = RequestMethod.POST)
    @ResponseBody
    ...
    private Map<String, Object> resoveParams(Integer affiliationId, String userName,
                                             ...
                                             String startTime, String endTime, String deviceNumber) {
        Map<String, Object> map = new HashMap<>();
        if (affiliationId != null) {
            map.put("affiliationId", affiliationId);
        }
    ...
    public ResponseVo test2() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            map.put("机型", "PC200-M");
            map.put("机号","CD1234");
            map.put("创建时间","2018-11-15 08:51:333");
            list.add(map);
        }
        return ResponseVo.success(list);
    }
