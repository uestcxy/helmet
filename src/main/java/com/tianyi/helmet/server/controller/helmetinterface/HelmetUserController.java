...
//     * @return
//     */
//    @RequestMapping(value = "regetYunToken")
//    @ResponseBody
//    @Deprecated //似乎没用
//    public AppAccountVo regetYunToken(@RequestParam String device_id) {
//        logger.debug("用户重新获取token:device_id=" + device_id);
//        NeteaseUser userInfo = neteaseUserService.selectByDeviceId(device_id);
//        if (userInfo == null) {
//            return new AppAccountVo("600", "设备不存在:" + device_id);
//        }
//        return neteaseUserService.regetNeteaseToken(userInfo);
//    }
