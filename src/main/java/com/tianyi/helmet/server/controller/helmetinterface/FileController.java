...
public class FileController {
    ...
    public ResponseVo<String> upload(@RequestParam("file") MultipartFile file,
        ...
        ResponseVo vo = uploadEntityServiceFactory.upload(UploadEntityTypeEnum.file, file, userId, helmetImei, neUserName, createTime, machineCode, "upload", tag, null, null, null);
        return vo;
    }
