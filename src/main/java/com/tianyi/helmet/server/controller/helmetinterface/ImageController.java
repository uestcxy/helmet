...
public class ImageController {
    ...
    public ResponseVo upload(@RequestParam("imagefile") MultipartFile file,
        ...
        ResponseVo vo = uploadEntityServiceFactory.upload(UploadEntityTypeEnum.image, file,userId,helmetImei, neUserName, createTime, machineCode, description, tag, null, null, null);
        return vo;
    }
