...
public class AudioController {
    ...
    public ResponseVo upload(@RequestParam("audiofile") MultipartFile file,
                             ...
                             @RequestParam("neUserName") String neUserName, HttpServletRequest request) {
        /**
        ...
        ResponseVo vo = uploadEntityServiceFactory.upload(UploadEntityTypeEnum.audio, file, userId, helmetImei, neUserName, createTime, machineCode, description, tag, null, null, null);
        return vo;
    }
