...
public class MediaController {
    ...
    public String loadSearchResultData(@PathVariable String resType, @PathVariable String orderBy, @RequestParam(required = false) String keyword, @RequestParam(required = false) Integer page, Model model) {
        ...
        if (typeEnum == null || !(UploadEntityTypeEnum.video.equals(typeEnum) || UploadEntityTypeEnum.image.equals(typeEnum))) {
            ...
            if (!StringUtils.isEmpty(keyword)) {
                ...
                //没输入标签则查询全部
                vo = uploadEntityServiceFactory.listData(typeEnum, null, null, page, pageSize);
            }
        }
