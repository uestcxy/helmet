...
public interface UploadEntityService<T extends UploadEntity> {
     ...
     */
    ResponseVo<T> addNewFile(byte[] bytes, String fileName, String suffix, String description, Date createTime,int userId, String clientId,String neUserName, String src, String machineCode, String tag, String orderNo, Float lon, Float lat);
