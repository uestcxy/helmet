...
public class UploadEntityServiceFactory {
    ...
    public ResponseVo  upload(UploadEntityTypeEnum type, MultipartFile file,int userId, String clientId,String neUserName, Date createTime, String machineCode, String description, String tag, String orderNo,Float lon,Float lat) {
        ...
        try {
             ...
             */
            ResponseVo vo = uploadEntityServiceFactory.getUploadEntityService(type).addNewFile(bytes, file.getOriginalFilename(), suffix, description, createTime,userId, clientId, neUserName,"upload", machineCode, tag, orderNo,lon,lat);
    ...
    public PageListVo<UploadEntity> listData(UploadEntityTypeEnum type, String searchKey, Object searchVal, int page, int pageSize) {
        ...
        for(UploadEntity uploadEntity:list){
            ...
            if(userId == -1 || userId == 0){
                ...
                String account = userService.selectById(userId).getAccount();
