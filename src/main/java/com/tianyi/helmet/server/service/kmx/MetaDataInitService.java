...
//        }
        ...
        DeviceType dt = deviceTypeService.newDeviceType(SensorSupport.HELMET_DEVICETYPE_ID, "田一智能头盔版本1", allSensorList);
        deviceTypeService.saveDeviceType(dt);
    }
...
//        }
        ...
        DeviceType dt = deviceTypeService.newDeviceType(SensorSupport.TYBOX_DEVICETYPE_ID, "天远盒子", sensorList);
        deviceTypeService.saveDeviceType(dt);
    }
...
//        Device device = deviceService.getDevice(helmetClientId);
//        if (device != null)
//            return true;
...
//        Device device = deviceService.getDevice(imei);
//        if (device != null)
//            return true;
