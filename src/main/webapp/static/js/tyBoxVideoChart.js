...
var playByTimeChartData = function (currTime) {
    ...
    $.each(chartMap, function (chartId, myChart) {
        ...
        if (chartId == "video_chart_0") {
            var _min = parseInt(referenceValueList.ROTATION.OIL_PRESSURE.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.OIL_PRESSURE.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_1") {
            var _min = parseInt(referenceValueList.ROTATION.REVOLUTION_SPEED.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.REVOLUTION_SPEED.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_2") {
            var _min = parseInt(referenceValueList.ROTATION.ELECTRIC_CURRENT_R.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.ELECTRIC_CURRENT_R.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_3") {
            var _min = parseInt(referenceValueList.ROTATION.WATER_TEMPERATURE.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.WATER_TEMPERATURE.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_4") {
            var _min = parseInt(referenceValueList.ROTATION.PUMP_PRESSURE_F.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.PUMP_PRESSURE_F.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_5") {
            var _min = parseInt(referenceValueList.ROTATION.PUMP_PRESSURE_R.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.PUMP_PRESSURE_R.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_6") {
            var _min = parseInt(referenceValueList.ROTATION.FUEL_CONSUMPTION.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.FUEL_CONSUMPTION.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_7") {
            var _min = parseInt(referenceValueList.ROTATION.ELECTRIC_CURRENT_F.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.ELECTRIC_CURRENT_F.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        } else if (chartId == "video_chart_8") {
            var _min = parseInt(referenceValueList.ROTATION.TORQUE_PERCENT.stateLower); //修改此处 为最小值 //$$$$$$$$$ 需要你写代码的地方
            var _max = parseInt(referenceValueList.ROTATION.TORQUE_PERCENT.stateUp); //修改此处 为最大值 //$$$$$$$$$ 需要你写代码的地方
        }
        myChart.setOption({
            series: [{
                markLine: {
