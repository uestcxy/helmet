    ...
    <div class="panel clearfix" id="searchSection">
        ...
        <div class="panel-body col-md-6" id="searchDiv">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <button class="btn btn btn-danger pull-right" type="button" id="add-button" title="新增客户">
            ...
            <div id="show-more" style="display: none">
                <div class="input-group">
                    <input type="text" id="contact" placeholder="请输入联系人" class="form-control" />
                ...
                <div class="input-group">
                    ...
                    <label for="province" class="input-group-addon">省份</label>
                </div>
                ...
                <div class="input-group">
                    ...
                    <label for="city" class="input-group-addon">城市</label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-body center-block" style="width: 50%;">
        ...
        <div>
            ...
            <div id="addForm2">
                ...
                <div class="input-group">
                    <input type="text" id="add_birthday" placeholder="生日(格式:2000-01-01,默认:2000-01-01)" class="form-control" value="" />
