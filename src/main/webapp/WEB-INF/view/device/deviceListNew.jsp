...
<div id="qrCodeModal" class="modal" style="top:20%">
    <div class="panel panel-body center-block" style="width: 50%;">
        <h4 id="qrCodeModalTitle">初始化账号 请用头盔扫码二维码</h4>
        <div id="behind" class="modal">
            <h4>头盔信息</h4>
            <p></p>
            <div>
                <div class="input-group">
                    <input disabled="disabled" type="text" id="i_imei" placeholder="设备imei" class="form-control"
                           oninput="initQrCode()">
                    <span class="input-group-addon">设备imei</span>
                </div>
                <div class="input-group">
                    <input disabled="disabled" type="text" id="i_version" placeholder="软件版本" class="form-control"
                           oninput="initQrCode()">
                    <span class="input-group-addon">软件版本</span>
                </div>
                <div class="input-group">
                    <input disabled="disabled" type="text" id="i_category" placeholder="品类" class="form-control"
                           oninput="initQrCode()">
                    <span class="input-group-addon">品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;类</span>
                </div>
                <div class="input-group">
                ...
                <div style="margin-top:30px;margin-bottom: 10px;" align="center">
                    <a class="waves-effect waves-light btn btn-primary" onclick="addDevice()">确定</a>
                    <a class="waves-effect waves-light btn btn-primary" data-dismiss="modal" aria-label="Close"><i
                            class="fa fa-close"></i>关闭</a>
                </div>
            </div>
        </div>
        <span id="before" style="font-family:Microsoft YaHei;font-size:18px;">
...
<div id="editDeviceModal" class="modal" style="top:20%">
    <div class="panel panel-body center-block" style="width: 50%;">
        <div>
            ...
            <div id="regForm1">
                <div class="input-group">
                    <input type="text" disabled="disabled" id="edit_userName" placeholder="持有人" class="form-control">
                    <label for="edit_userName" class="input-group-addon">&nbsp;持&nbsp;有&nbsp;人&nbsp;</label>
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    <select class="form-control" id="edit_model" data-init="false">
                    </select>
                ...
                <div class="input-group">
                    <select class="form-control" id="edit_batchSelect" data-init="false">
                    </select>
...
<script>
    var newPagePager = {};
    newPagePager.allHelmetWebSocketQueryString = "?token=${websocketToken}&dataType=device";
    $(function () {
...
<script src="/static/js/deviceListNew.js?v=${version}"></script>
